	...
	<!-- topbar ends -->
		...
		<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>商品专题管理</h2>
						<div class="box-icon">
							<a href="${ctx}/topicgoods/operation.do?uid=${user.id}&id=0&flag=add" class="btn btn-add btn-round"><i class=" icon-plus"></i></a>
						</div>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="${ctx}/topicgoods/operation.do?uid=${user.id}&id=${node.id}&flag=update">
										<i class="icon-edit icon-white"></i> 修改   </a>
									<a class="btn btn-danger" href="${ctx}/topicgoods/delete.do?uid=${user.id}&id=${node.id}">
										<i class="icon-trash icon-white"></i> 删除</a>
									<a class="btn btn-success" href="${ctx}/topicgoods/oparticles.do?uid=${user.id}&id=${node.id}" >
									<i class="icon-zoom-in icon-white"></i>商品</a>
								</td>
							</tr>
							</c:forEach>
						  </tbody>
