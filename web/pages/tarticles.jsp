...
<body>
	<!-- topbar ends -->
		...
		<div class="box span12">
					...
					<form class="form-horizontal" id="listform" action="${ctx}/topicarticle/addtoparticles.do?uid=${user.id}&id=${model.id}" method="post">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								<td>
									<label class="checkbox inline">
									  		<input type="checkbox" id="article" name= "article" value="${node.id}">
									 </label>
								</td>
