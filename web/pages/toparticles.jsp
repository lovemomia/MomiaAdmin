		...
		<div class="row-fluid">
			...
			<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> 专题文章</h2>
						<div class="box-icon">
							<a href="${ctx}/topicarticle/getarticles.do?uid=${user.id}&id=${model.id}" class="btn btn-add btn-round"><i class=" icon-plus"></i></a>
							<!-- <a href="${ctx}/topicarticle/info.do?uid=${user.id}" class="btn btn-close btn-round"><i class="icon-remove"></i></a> -->
						</div>
					</div>
					<div class="box-content">
					<form class="form-horizontal" id="toparticleform" action="${ctx}/topicarticle/info.do?uid=${user.id}" method="post">
