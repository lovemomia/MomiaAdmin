...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 修改商品分类</h2>
						<div class="box-icon">
							<a href="${ctx}/assortgoods/info.do?uid=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="assortform" action="${ctx}/assortgoods/update.do?uid=${user.id}&id=${model.id}" method="post">
							<fieldset>
