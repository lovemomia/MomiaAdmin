...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div class="box-icon">
							<a href="${ctx}/goods/info.do?uid=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="goodsform" action="${ctx}/goods/insert.do?uid=${user.id}" method="post">
							<fieldset>
							<div class="control-group">
							   ...
							   <div class="control-group">
							  <label class="control-label" for="trdesc">推荐心得</label>
							  <div class="controls">
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">推荐商品图片</label>
								<div class="controls">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <c:forEach items="${assorts}" var="node">
								  	<label class="checkbox inline">
								  		<input type="checkbox" id="assort" name= "assort" value="${node.id}">${node.name}
								  		</label>
								  </c:forEach>
								</div>
							  </div>
...
<script type="text/javascript">
			...
			$(function () {
		        ...
		        $("#confirmbtn").click(function () {
		            ...
		            if (title == "" || abstracts == "" || picUrl == "" ) {
		                alert("对不起! 您的[标题]、[推荐心得]和[推荐商品图片]为必填项！");
		                return false;
		            }else{
		            	$("#goodsform").submit();
		            }
