...
<body>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" id="userform" action="${ctx}/user/adduser.do?id=${user.id}" method="post">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="abstracts" name="abstracts" type="text" value="">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">微信号</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="wechatNo" name="wechatNo" type="text" value="">
								</div>
							  </div>
							</fieldset>
						  </form>
