...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 修改文章专题</h2>
						<div class="box-icon">
							<a href="${ctx}/topicarticle/info.do?uid=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="toparticleform" action="${ctx}/topicarticle/update.do?submitType=2&uid=${user.id}&id=${model.id}" method="post">
							<fieldset>
	...
	$(function () {
        ...
        $("#savebtn").click(function () {
            ...
            if (title == "" || abstracts == "" || beginTime == "" || endTime == "" || picUrl == "" ) {
            	...
            	$("#toparticleform").attr("action", $("#path").val()+"/topicarticle/update.do?submitType=1&uid="+$("#uid").val()+"&id="+$("#id").val());
            	$("#toparticleform").submit();
            }
        });
