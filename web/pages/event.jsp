	...
	<!-- topbar ends -->
		...
		<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						...
						<div class="box-icon">
							<a href="${ctx}/event/operation.do?uid=${user.id}&id=0&flag=add" class="btn btn-add btn-round"><i class=" icon-plus"></i></a>
						</div>
					</div>
