	...
	<!-- topbar ends -->
		...
		<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						...
						<div class="box-icon">
							<a href="${ctx}/user/operation.do?id=${user.id}&flag=add&uid=0" class="btn btn-add btn-round"><i class=" icon-plus"></i></a>
						</div>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><c:out value="${entity.password}"></c:out></td>
								<td><c:out value="${entity.wechatNo}"></c:out></td>
								<td><c:out value="${fn:substring(entity.addTime,0,19)}"></c:out></td>
								<td class="center">
									<a class="btn btn-info" href="${ctx}/user/operation.do?id=${user.id}&uid=${entity.id}&flag=update">
										<i class="icon-edit icon-white"></i>  
										修改                                            
									</a>
									<a class="btn btn-danger" href="${ctx}/user/deluser.do?id=${user.id}&uid=${entity.id}">
