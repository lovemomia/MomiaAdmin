...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 添加商品链接</h2>
						<div class="box-icon">
							<a href="${ctx}/goodslink/info.do?uid=${user.id}&gid=${gid}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="linkform" action="${ctx}/goodslink/insert.do?uid=${user.id}&gid=${gid}" method="post">
							<fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea  id="goodUrl" name="goodUrl" rows="3"></textarea>
								<span class="help-inline">必填项</span>
							  </div>
							</div>
							<div class="control-group">
							 ...
							 <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="origin" name="origin" type="text" value="">
								  <span class="help-inline">必填项</span>
								</div>
							  </div>
							</fieldset>
...
//	alert("对不起! 您的[价格]格式不正确,请输入数字或带小数的数字！");
// 	return false;
// }else if(isNaN(origin)){
//	alert("对不起! 您的[排序值]格式不正确,请输入数字！");
// 	return false;
//}
	$(function () {
