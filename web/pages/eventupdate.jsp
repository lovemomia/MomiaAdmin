...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 修改活动</h2>
						<div class="box-icon">
							<a href="${ctx}/event/info.do?uid=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="eventform" action="${ctx}/event/update.do?uid=${user.id}&id=${model.id}" method="post">
							<fieldset>
							<div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="subtitle" name="subtitle" type="text" value="${model.subtitle}">
								</div>
							  </div>
							   <div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea  id="eventUrl" name="eventUrl" rows="3">${model.eventUrl}</textarea>
							  </div>
							</div>
							<div class="control-group">
