		...
		<div class="row-fluid">
			...
			<!-- content starts -->
				<div class="sortable row-fluid">
					...
					<a data-rel="tooltip" title="首页" class="well span3 top-block" href="${ctx}/user/spage.do?id=${user.id}">
						<span class="icon32 icon-color icon-home"></span>
						<div>首页</div>
						<div>&nbsp</div>
						<span></span>
					</a>
					<a data-rel="tooltip" title="文章分类" class="well span3 top-block" href="${ctx}/assortarticle/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="商品分类" class="well span3 top-block" href="${ctx}/assortgoods/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="文章专题制作" class="well span3 top-block" href="${ctx}/topicarticle/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="商品专题制作" class="well span3 top-block" href="${ctx}/topicgoods/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="文章编辑管理" class="well span3 top-block" href="${ctx}/article/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="推荐商品编辑" class="well span3 top-block" href="${ctx}/goods/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="各类活动制作" class="well span3 top-block" href="${ctx}/event/info.do?uid=${user.id}">
					...
					<a data-rel="tooltip" title="用户信息管理" class="well span3 top-block" href="${ctx}/user/info.do?id=${user.id}">
					...
					<a data-rel="tooltip" title="用户意见反馈" class="well span3 top-block" href="${ctx}/feedback/info.do?uid=${user.id}">
