...
<body>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" id= "articleform" action="${ctx}/article/insert.do?uid=${user.id}" method="post">
							<input  id="path"  type="hidden" value="${imgPath}" >
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <c:forEach items="${users}" var="node">
										<option value="${node.id}" >${node.username}</option>
									</c:forEach>
								  </select>
								</div>
							  </div>
