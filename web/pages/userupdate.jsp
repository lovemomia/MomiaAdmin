...
<body>
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div class="box-icon">
							<a href="${ctx}/user/info.do?id=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="userform" action="${ctx}/user/updateuser.do?id=${user.id}&uid=${model.id}" method="post">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="abstracts" name="abstracts" type="text" value="${model.abstracts}">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">微信号</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="wechatNo" name="wechatNo" type="text" value="${model.wechatNo}">
								</div>
							  </div>
							</fieldset>
						  </form>
